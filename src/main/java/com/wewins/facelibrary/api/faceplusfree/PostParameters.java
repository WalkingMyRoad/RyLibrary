...
public class PostParameters {
	...
	private StringBuilder paramStrings;
	...
	public PostParameters() {
		...
		paramStrings = new StringBuilder();
	}
	...
	public PostParameters setImg(File file) {
		multiPart.addPart("image_file", new FileBody(file));
		return this;
	}
	...
	public PostParameters setImg(byte[] data, String fileName) {
		multiPart.addPart("image_file", new ByteArrayBody(data, fileName));
		return this;
	}
	 ...
	 * @return this
	 */
	public PostParameters setFaceToken1 (String id){
		addString("face_token1", id);
		return this;
	}
	 ...
	 * @return this
	 */
	public PostParameters setFaceToken2 (String id){
		addString("face_token2", id);
		return this;
	}
	 ...
	 * @return this
	 */
	public PostParameters setKeyFaceToken (String id){
		addString("key_face_token", id);
		return this;
	}
	 ...
	 * @return this
	 */
	public PostParameters setFaceToken (String faceToken) {
		addString("face_token", faceToken);
		return this;
	}
	 ...
	 * @return this
	 */
	public PostParameters setFaceToken (String[] faceTokens) {
		return setFaceToken(toStringList(faceTokens));
	}
	/**
	 * person_id=... , ... , ...
	 * @param personIds
	 ...
	 * @return this
	 */
	public PostParameters setFaceToken (ArrayList<String> faceTokens) {
		return setFaceToken(toStringList(faceTokens));
	}
	/**
	 * person_id=... , ... , ...
	...
	private void addString(String id, String str) {
		try {
			...
			paramStrings.append("paramName = " + id + ", paramValue = " + str);
