    ...
    private Retrofit initRetrofit(String url){
        try{
            BasicParamsInterceptor basicParamsInterceptor= new BasicParamsInterceptor.Builder()
                    .addParam("mallId", SharedPreferencesController.getInstance().getMailId())
                    .addParam("robotNo",SharedPreferencesController.getInstance().getRobotNumber())
                    .addQueryParam("mallId", SharedPreferencesController.getInstance().getMailId())
                    .addQueryParam("robotNo",SharedPreferencesController.getInstance().getRobotNumber())
                    .build();
